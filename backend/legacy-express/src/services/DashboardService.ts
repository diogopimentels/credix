import { LoansRepository } from '../../src/repositories/LoansRepository';

export class DashboardService {
    constructor(private loansRepository: LoansRepository) { }

    async getMetrics() {
        const metrics = await this.loans_repository.getDashboardMetrics();

        const loans = await this.loans_repository.findAll();
