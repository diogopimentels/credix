        ...
        <header className="sticky top-0 z-40 w-full border-b border-border/40 bg-background/60 backdrop-blur-xl supports-[backdrop-filter]:bg-background/60">
            <div className="flex h-16 items-center px-4 md:px-8 justify-between gap-4">
                <div className="flex items-center gap-4">
                    ...
                    {/* Desktop Search Bar */}
                    <div className="hidden md:flex items-center gap-2 rounded-md border border-border/60 bg-background/70 px-3 h-10 w-[clamp(12rem,30vw,20rem)] focus-within:border-primary/80 focus-within:ring-1 focus-within:ring-ring transition-all duration-300">
